...
# access token. Confirmed live: no API version prefix, the call to
# api.nanit.com/speakers/<uid>/udtokens returns 200 with the nanit-api-version
# header. A 404 here just leaves the integration on the remote relay.
